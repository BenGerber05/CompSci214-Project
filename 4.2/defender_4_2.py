...
from enemy_4_2 import Functions, Bonus, Enemy
...
def main(): #Worked on by Rourke: 27547957, Ben: 27943607, and Zak 27855325
    ...
    while ingame: 
        ...
        Functions.ref_right = Enemy.HOR_SPACING*(Enemy.COLUMNS-1) + Enemy.HOR_START    
        Enemy.ref_direction = 1
        projectiles.clear()
        enemy_projectiles.clear()
        shields.clear()
        enemy_last_fire.clear()
                    ...
                    for enemy in row:
                        if enemy.is_hit(proj):
                            ...
                            if enemy.health <= 0:
                                ...
                                if isinstance(enemy, Bonus): #drop power up if a bonus enemy is killed
                                    power_up_sound.play()
