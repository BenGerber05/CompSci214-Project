...
class Brute(Enemy): #Standard no functionality
    ...
    def draw(self):
        ...
        stddraw.picture(self.brute_image, self.x + 0.05, self.y+0.05,  self.image_scalar ,  self.image_scalar )
    def score(self):
        return 100  
...
class Shooter(Enemy): #Shoots standard bullets
    ...
    def draw(self):
        ...
        stddraw.filledRectangle(self.x, self.y, 0.1, 0.1)  
        stddraw.picture(self.shooter_image, self.x+0.05, self.y+0.05,  self.image_scalar , self.image_scalar )
    def shoot(self):
        pass
    def score(self):
        return 200  
...
class Bomber(Enemy): #Shoots bullets with blast radius 
    ...
    def draw(self):
        ...
        stddraw.filledRectangle(self.x, self.y, 0.1, 0.1)  
        stddraw.picture(self.bomber_image, self.x+0.05, self.y+0.05, self.image_scalar  ,self.image_scalar) 
    def shoot(self):
        pass
    def score(self):
        return 300  
...
class Bonus(Enemy): #Drops Power ups
     ...
     def draw(self): 
        ...
        stddraw.filledRectangle(self.x, self.y, 0.1, 0.1)  
        stddraw.picture(self.bonus_image, self.x+0.05, self.y+0.05, self.image_scalar  ,  self.image_scalar )
     def dropPowerUp():
         pass
     def score(self):
        return 400  
